...
# Special treatment of package import error
...
master_doc = 'CFDEMcoupling_Manual'

# General information about the project.
project = 'CFDEMcoupling Academic'
copyright = '2018 JKU Linz and DCS Computing GmbH'

def get_cfdemcoupling_version():
    import os
    script_dir = os.path.dirname(os.path.realpath(__file__))
    #with open(os.path.join(script_dir, '../src/lagrangian/cfdemParticle/cfdTools/versionInfo.H'), 'r') as f:
...
version = get_cfdemcoupling_version()
# The full version, including alpha/beta/rc tags.
release = version

rst_epilog = """
.. |ProjectVersion| replace:: Academic version {versionnum}
""".format(
versionnum = version,
)
...
htmlhelp_basename = 'CFDEMcouplingdoc'
...
texinfo_documents = [
  ('Manual', 'CFDEMcoupling', 'CFDEMcoupling Documentation',
   'CFDEMcoupling', 'One line description of project.',
   'Miscellaneous'),
]
